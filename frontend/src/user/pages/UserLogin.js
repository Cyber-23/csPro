...
export default function UserLogin() {
  ...
  return (
    <>
    <div className="lg:flex  user-login-bg h-screen">
      <div className="flex md:w-1/2 m-auto justify-center lg:items-center md:h-screen pt-12">
        <div className="justify-center bg-gray-100 bg-opacity-30 backdrop-filter backdrop-blur-lg rounded-2xl shadow-2xl">
          <div className="sm:mx-auto sm:w-full sm:max-w-sm">
            <div className="w-full bg-white bg-opacity-30 backdrop-filter backdrop-blur-lg rounded-t-2xl py-4">
              <img className="mx-auto h-10 w-auto" src="/logo.png" alt="cybersolvings" />
            </div>
            ...
            <form className="space-y-8" onSubmit={formik.handleSubmit}>
              ...
              <div className="mt-2">
                <div className="relative">
                  ...
                  >
                    {!showPass ? (
                      <FaRegEye className="h-6 w-6 text-gray-600" aria-hidden="true" />
                    ) : (
                      <FaRegEyeSlash className="h-6 w-6 text-gray-600" aria-hidden="true" />
                    )}
                  </span>
                </div>
