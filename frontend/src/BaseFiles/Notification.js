...
export default function Notification({ openNotification, close }) {
  ...
  useEffect(() => {
    if (action === "all") {
      ...
      setAllticket(tickets?.filter((t) => t?.notification === action));
    }
  }, [action, allticket]);
  return (
    <Dialog open={openNotification} onClose={close} className="relative z-50">
                  ...
                  {allticket?.map((tik,index) => (
                    <li key={index}>
                      <div className={classNames(
                        ...
                        <a href={tik?.status} className="-m-1 block flex-1 p-1">
                          <div
                            aria-hidden="true"
                          ...
                          <div className="relative flex min-w-0 flex-1 items-center">
                            ...
                            <div className="ml-4 truncate">
                              <p className="truncate text-sm font-medium text-gray-900">
                                A new Ticket request from project no . {tik?.registration}
                              </p>
