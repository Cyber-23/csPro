  ...
  export default function Footer() {
    return (
      <footer className="bg-gray-900" aria-labelledby="footer-heading">
        ...
        <div className="mx-auto max-w-7xl px-6 pb-8 pt-10 sm:pt-6 lg:px-8 lg:pt-16">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <div className="  xl:mt-0">
              <img className="lg:w-full md:w-[200px] md:h-[200px] " src="/logo.png"/>
          ...
          <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 md:flex md:items-center md:justify-between lg:mt-12">
            ...
            <p className="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">
              &copy; 2024 Cyber Solvings, Inc. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
